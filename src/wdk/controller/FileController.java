...
//import static wolfieballdraftkit.WDK_PropertyType.COURSE_SAVED_MESSAGE;
//import static wolfieballdraftkit.WDK_PropertyType.NEW_COURSE_CREATED_MESSAGE;
...
import static wolfieballdraftkit.WDK_PropertyType.SAVE_UNSAVED_WORK_MESSAGE;
import static wolfieballdraftkit.WDK_StartupConstants.JSON_FILE_PATH_LAST_INSTRUCTOR;
//import static wolfieballdraftkit.WDK_StartupConstants.PATH_COURSES;
...
public class FileController {
   ...
   /**
     ...
     *//*
    public void handleSaveCourseRequest(WDK_GUI gui, Course courseToSave) {
        try {
            // SAVE IT TO A FILE
    ...
    public void handleExportCourseRequest(WDK_GUI gui) {
        ...
        try {            
            ...
            Stage ayya = new Stage();            
            ProgressDialog ayy = new ProgressDialog(ayya, courseToExport, courseURL);
